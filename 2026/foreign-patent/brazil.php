      ...
      <article class="country-article brazil-article article-content article-panel reveal">
        ...
        <div class="article-sheet">
          <header class="article-sheet-header">
            <p>巴西專利 Busca Web INPI 網址：<a href="https://busca.inpi.gov.br/" target="_blank" rel="noopener noreferrer">https://busca.inpi.gov.br/</a></p>
          </header>
            ...
            <div class="article-body">
              <div class="data-table-wrap">
                <table class="data-table china-patent-table brazil-patent-table">
                  <thead><tr><th scope="col">專利／保護種類</th><th scope="col">保護年限<br>（自申請日起算）</th><th scope="col">審查制度</th><th scope="col">核心保護標的</th></tr></thead>
                  <tbody>
                    <tr><th scope="row">發明專利</th><td>20 年</td><td>全面實體審查制<br>（須主動提審查請求）</td><td>具備新穎性、進步性與產業利用性的技術產品或方法。</td></tr>
                    <tr><th scope="row">新型專利</th><td>15 年<br>（保護年限在全球屬於偏長者）</td><td>全面實體審查制<br>（必須審查進步性）</td><td>針對實體物品（如工具、器具）在形狀、結構上，能提升其使用功能或製造效益的全新改良（排除方法／製程）。</td></tr>
                    <tr><th scope="row">工業設計<br>（即設計專利）</th><td>10 年<br>（可展延 3 次，每次 5 年，最長 25 年）</td><td>登記制／形式審查<br>（可後置申請實體審查）</td><td>產品全部或部分的創新外形、線條、色彩或圖案等具備可工業再現性的外觀特徵。</td></tr>
                  </tbody>
                </table>
              </div>
            </div>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              ...
              <h4>快速的臨時禁令（Preliminary Injunctions）：</h4>
              <p>雖然最終判決可能因法院雙軌制而拖延數年，但巴西州法院的法官在訴訟初期，相當願意在原告提供初步證據或擔保的情況下，快速簽發「臨時禁令（PI）」，強制被告立即停工、停售或扣押侵權貨品，是權利人極佳的卡位武器。</p>

              <h4>刑事起訴與突擊搜查：</h4>
              <p>在巴西，專利侵權亦屬於刑事犯罪（由 LPI 規範）。專利權人可以向警方報案，申請刑事搜查令和扣押令，直接前往涉嫌侵權者的工廠、倉庫進行突擊搜查並查封侵權商品與生產機具。</p>

              <h4>損害賠償與利潤損失的推定：</h4>
              <p>原告在州法院打贏侵權官司後，損害賠償可以依據以下三者中「對權利人最有利」的方式計算：1. 權利人因侵權所受的實際損失；2. 侵權人因侵權所獲得的非法利潤；3. 侵權人若獲得合法授權原本應支付的權利金。</p>

              <h4>消滅時效：</h4>
              <p>專利侵權民事訴訟的追訴與損害賠償請求權時效，為自侵權行為發生之日起算 5 年。</p>
            </div>
          </section>
        </div>
      </article>
