<?php
$baseHref = '../';
$pageTitle = '中國專利 | 國外專利 | 聯律國際專利商標事務所';
    ...
    <div class="page-content">
      ...
      <article class="country-article china-article article-content article-panel reveal">
        <div class="country-article-heading">
          <div><p class="country-article-kicker">China Patent</p><h2>中國專利</h2></div>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              ...
              <ul class="content-list">
                <li><strong>新穎性：</strong>該技術方案不屬於「現有技術」。在申請日以前，沒有任何同樣的發明或實用新型在國內外出版物上發表過、被公開使用過，或以其他方式為公眾所知。同時，也沒有其他人向專利局提出過相同的申請並記載在申請日後公布的專利文件中。</li>
                <li><strong>創造性：</strong>與現有技術相比，該專利必須具有實質性的特點和進步。發明專利要求具有「突出的」實質性特點和「顯著的」進步；實用新型專利則要求具有實質性特點和進步。</li>
                <li>實用性：該發明或實用新型必須能夠製造或者使用，並且能夠產生積極、有益的效果。</li>
              </ul>
