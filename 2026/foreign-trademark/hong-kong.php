<?php
$baseHref = '../';
$pageTitle = '香港商標 | 國外商標 | 聯律國際專利商標事務所';
$pageDescription = '香港商標申請要件、申請程序、商標權期限及爭議救濟資訊。';
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              ...
              <ul class="content-list">
                ...
                <li>不得僅由商品或服務交易上慣用的標誌或表示所構成</li>
                <li>不能僅直接表示商品或服務的種類、品質、用途、價值、地理來源、製造時間等特徵</li>
              </ul>
              <p><strong>排除在先權利衝突：</strong>商標不能與他人已經在香港註冊或申請中的商標相同或高度近似，且指定商品/服務相同或類似，以避免消費者產生混淆。</p>
              <h4>禁止惡意搶註與欺騙性</h4>
              <ul class="content-list">
                <li>申請人明知該商標是他人已經具有一定知名度的品牌，而意圖以不正當競爭、索取高額轉讓費為目的進行搶註</li>
                <li>不得惡意申請</li>
              </ul>
              <h4>違反公共秩序與特定限制</h4>
              <ul class="content-list">
                <li>不得包含國旗、國徽、官方標誌、國際組織標誌等受保護標誌</li>
                <li>不得具有欺騙性、違反公共政策或法律禁止規定</li>
              </ul>
              <p><strong>優先權：</strong>若該商標已在巴黎公約或WTO會員國第一次提出申請，可在6個月內向香港主張優先權。</p>
            </div>
          </section>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              <ol class="content-list">
                <li><strong>商標檢索：</strong>在提交前先於香港知識產權署（IPD）資料庫進行檢索，確認是否有相同或近似商標已存在，以降低被駁回風險。</li>
                <li><strong>提交申請：</strong>準備商標圖樣、指定商品/服務類別(採用尼斯分類)，並載明申請人名稱、申請人地址、申請人國籍、商標圖樣、指定商品及服務，由當地代理人向IPD遞交。</li>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              ...
              <ul class="content-list">
                ...
                <li>異議人可以基於以下幾項法定理由向香港知識產權署（IPD）提出異議:</li>
              ...
              <h4>評定</h4>
              <ul class="content-list">
                <li>在香港商標制度中是透過向香港知識產權署(Trade Marks Registry) 申請商標註冊無效。</li>
                ...
                <li>侵害他人在先權利：包括姓名權、著作權、外觀設計權或其他依法受保護之權利</li>
                <li>惡意申請：明知他人在先使用該商標，仍基於不正當目的申請註冊</li>
              </ul>
              <p><strong>撤銷：</strong>註冊商標連續3年以上未於香港就核准商品或服務真實使用，任何人均可向香港知識產權署申請撤銷（Revocation）全部或部分商標註冊。</p>
            </div>
          </section>
        </div>
      </article>
