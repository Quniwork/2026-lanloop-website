<?php
$baseHref = '../';
$pageTitle = '阿根廷商標 | 國外商標 | 聯律國際專利商標事務所';
$pageDescription = '阿根廷商標申請要件、申請程序、商標權期限及爭議救濟資訊。';
...
<main class="country-patent-page">
  ...
  <div class="container">
    <div class="page-content">
      <header class="page-header" aria-labelledby="argentina-trademark-title">
        <h1 id="argentina-trademark-title">國外商標 <small>Foreign Trademark</small></h1>
      ...
      <article class="country-article argentina-article article-content article-panel reveal">
        <div class="country-article-heading">
          <div><p class="country-article-kicker">Argentina Trademark</p><h2>阿根廷商標</h2></div>
          <a class="country-article-back" href="foreign-trademark.php">回國外商標制度列表</a>
        </div>

        <div class="article-sheet">
          <header class="article-sheet-header">
            <p>主管機關：<a href="https://www.argentina.gob.ar/inpi" target="_blank" rel="noopener noreferrer">阿根廷國家工業產權局(Instituto Nacional de la Propiedad Industrial, INPI)</a></p>
          </header>

          <section class="article-row">
            <h3 class="article-section-title">申請要件</h3>
            <div class="article-body">
              <p>讓消費者能夠識別個人或公司的產品或服務，以便將其與競爭對手的產品或服務區分開來。</p>
              <h4>不能註冊事由</h4>
              <ul class="content-list">
                <li>已普遍使用的名稱、字詞、標誌和廣告詞</li>
                <li>與先前註冊或申請註冊的商標相同或近似的商標</li>
                <li>違反道德的文字、圖畫和其他標誌</li>
              </ul>
            </div>
          </section>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              <p>若該商標已在台灣或其他WTO會員國第一次提出申請，可在6個月內向阿根廷國家工業產權局主張優先權。</p>
            </div>
          </section>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              <ol class="content-list">
                ...
                <li><strong>公告：</strong>審核通過會進入官方公告期，為期30天，在此期間內利害關係人可提出異議。</li>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              <ul class="content-list">
                ...
                <li><strong>使用證明：</strong>於商標核准後第5年至第6年屆滿前交使用宣誓。</li>
              </ul>
            </div>
          </section>
        </div>
