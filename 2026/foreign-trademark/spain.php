<?php
$baseHref = '../';
$pageTitle = '西班牙商標 | 國外商標 | 聯律國際專利商標事務所';
$pageDescription = '西班牙商標申請要件、申請程序、商標權期限及爭議救濟資訊。';
...
<main class="country-patent-page">
  ...
  <div class="container">
    <div class="page-content">
      <header class="page-header" aria-labelledby="spain-trademark-title">
        <h1 id="spain-trademark-title">國外商標 <small>Foreign Trademark</small></h1>
      ...
      <article class="country-article spain-article article-content article-panel reveal">
        <div class="country-article-heading">
          <div><p class="country-article-kicker">Spain Trademark</p><h2>西班牙商標</h2></div>
          <a class="country-article-back" href="foreign-trademark">回國外商標制度列表</a>
        </div>

        <div class="article-sheet">
          <header class="article-sheet-header">
            <p>主管機關：<a href="https://www.oepm.es/es/" target="_blank" rel="noopener noreferrer"> 西班牙專利商標局(Oficina Española de Patentes y Marcas,OEPM)</a></p>
          </header>

          <section class="article-row">
            <h3 class="article-section-title">申請要件</h3>
            <div class="article-body">
              <p>商標可以包括: 字、聲音、標誌、顏色、聲音等這些任意組合。</p>
              <ul class="content-list">
                <li><strong>顯著性：</strong>足以區別某一企業之商品或服務與其他企業之商品或服務。</li>
                <li><strong>明確性：</strong>能夠以適當方式呈現，使主管機關及一般大眾皆能清晰且明確地認定給予其所有人之保護範圍與標的。</li>
              </ul>
            </div>
          </section>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              <p>若該商標已在台灣或其他WTO會員國第一次提出申請，可在6個月內向西班牙專利商標局主張優先權。</p>
            </div>
          </section>
          ...
          <section class="article-row">
            ...
            <div class="article-body">
              <ol class="content-list">
                <li><strong>商標檢索：</strong>在提交前先於OEPM資料庫進行檢索，確認是否有相同或近似商標已存在，以降低被異議風險。</li>
                <li><strong>提交申請：</strong>準備商標圖樣、指定商品/服務類別(採用尼斯分類)，並載明申請人名稱、申請人地址、申請人國籍、商標圖樣、指定商品及服務，由當地代理人向OEPM遞交。</li>
