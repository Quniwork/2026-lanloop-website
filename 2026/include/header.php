...
$pageExt = substr($pagePath, -4) === '.php' ? substr($pagePath, 0, -4) : $pagePath;
$canonicalUrl = $siteUrl . '/' . ($pageExt === 'index' ? '' : $pageExt);
...
<body>
  ...
  ====================================================== -->
    <div class="mobile-menu" id="mobileMenu" role="dialog" aria-label="行動版選單">
      ...
      <a href="about" class="mobile-nav-link" onclick="closeMobileMenu()">關於聯律</a>
      <a href="services" class="mobile-nav-link" onclick="closeMobileMenu()">服務範圍</a>
      <a href="foreign-patent" class="mobile-nav-link<?php if ($activeItem === 'patent') { ?> is-active<?php } ?>" onclick="closeMobileMenu()">國外專利</a>
      <a href="domestic-patent" class="mobile-nav-link<?php if ($activeItem === 'domestic-patent') { ?> is-active<?php } ?>" onclick="closeMobileMenu()">國內專利</a>
      <a href="foreign-trademark" class="mobile-nav-link<?php if ($activeItem === 'trademark') { ?> is-active<?php } ?>" onclick="closeMobileMenu()">國外商標</a>
      <a href="domestic-trademark" class="mobile-nav-link<?php if ($activeItem === 'domestic-trademark') { ?> is-active<?php } ?>" onclick="closeMobileMenu()">國內商標</a>
      <a href="links" class="mobile-nav-link" onclick="closeMobileMenu()">相關網站</a>
      <a href="contact" class="mobile-nav-link" onclick="closeMobileMenu()">聯絡我們</a>
      ...
      <div class="container">
        <header class="header">
          ...
          <nav class="nav" aria-label="主選單">
            <a href="about"<?php if ($activePage === 'about') { ?> class="is-active"<?php } ?>>關於聯律</a>
            <a href="services"<?php if ($activePage === 'services') { ?> class="is-active"<?php } ?>>服務範圍</a>
            ...
            <a href="links"<?php if ($activePage === 'links') { ?> class="is-active"<?php } ?>>相關網站</a>
            <a href="contact"<?php if ($activePage === 'contact') { ?> class="is-active"<?php } ?>>聯絡我們</a>
